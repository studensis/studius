...
_[slika 3.1] slika obrazaca uporabe kolegija_ <a name = "s3.1"> </a>

![usecases](./diagrams/UMLUseCase/Korisnici.svg)
_[slika 3.2] slika obrazaca uporabe korisnika_ <a name = "s3.2"> </a>

![usecases](./diagrams/UMLUseCase/Obavijesti.svg)
_[slika 3.3] slika obrazaca uporabe obavijesti_ <a name = "s3.3"> </a>

![usecases](./diagrams/UMLUseCase/Seminari.svg)
_[slika 3.4] slika obrazaca uporabe seminara_ <a name = "s3.4"> </a>
...
_[slika 3.5] slika sekvencijskog dijagrama prijave korisničkim podacima_ <a name = "s3.5"> </a>
...
_[slika 3.5] slika sekvencijkog dijagrama kreiranja računa_ <a name = "s3.5"> </a>
...
_[slika 3.6] slika sekvencijskog dijagrama izrade seminara_ <a name = "s3.6">

![sek4](./diagrams/UMLSequence/sdPredlaganjeSeminara.png)
_[slika 3.7] slika sekvencijskog dijagrama predlaganja seminara_ <a name = "s3.7">
