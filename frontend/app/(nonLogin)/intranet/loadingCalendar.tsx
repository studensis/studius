export default function LoadingCalendar() {
	...
	return (
		<div className=" min-w-full flex flex-col md:px-10 sm:px-6 py-10 bg-section rounded-xl">
			...
			<div>
				<div className="flex w-full mx-3 justify-between">
					{[...new Array(7)].map(() => (
						<div className="flex flex-col">
							{[...new Array(6)].map(() => (
								<div className="flex animated-background flex-1 text-center min-w-[32px] min-h-[32px] rounded-xl mr-[13.72px] mb-[8px] "></div>
							))}
						</div>
					))}
				</div>
